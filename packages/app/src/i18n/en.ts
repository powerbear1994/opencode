export const dict = {
  ...
  "requirements.title": "需求中心",
  "requirements.list.empty": "暂无需求",
  "requirements.list.error": "加载需求失败",
  "requirements.list.retry": "重试",
  "requirements.list.searchPlaceholder": "搜索需求...",
  "requirements.detail.back": "返回列表",
  "requirements.detail.notFound": "未找到该需求",
  "requirements.detail.error": "加载需求详情失败",
  "requirements.detail.projectUnavailable": "当前项目不可用，请返回项目后重新打开需求中心。",
  "requirements.detail.selectHint": "选择一条需求查看详情",
  "requirements.detail.assignee": "分配人",
  "requirements.detail.implementer": "实现人",
  "requirements.detail.description": "需求内容",
  "requirements.sidebar.metadata": "需求信息",
  "requirements.sidebar.noLinksHint": "创建或绑定会话后，可在这里追踪实现状态和快速打开关联会话。",
  "requirements.sidebar.noLinks": "暂无关联会话",
  "requirements.sidebar.implementationStatus": "实现状态",
  "requirements.sidebar.statusExplain": "取自所有关联会话中最活跃的状态。优先级：实现中 > 待检查 > 已创建会话 > 已填入会话 > 已完成 > 失败 > 未开始。",
  "requirements.sidebar.quickActions": "快捷操作",
  "requirements.sidebar.updatedAt": "更新时间",
  "requirements.sidebar.show": "显示侧栏",
  "requirements.sidebar.hide": "隐藏侧栏",
  "requirements.status.todo": "待处理",
  "requirements.status.doing": "进行中",
  "requirements.status.waiting_review": "待验收",
  "requirements.status.done": "已完成",
  "requirements.status.failed": "失败",
  "requirements.priority.high": "高",
  "requirements.priority.medium": "中",
  "requirements.priority.low": "低",

  // ── Agents ──────────────────────────────────────────────────────────────
  "agents.title": "Agents",
  "agents.detail.empty": "Select an agent to view details",
  "agents.list.empty": "No agents found",
  "agents.list.error": "Failed to load agents",
  "agents.list.retry": "Retry",
  "agents.editor.nameLocked": "Agent name cannot be changed after creation.",
  "agents.editor.name": "Agent Name",
  "agents.editor.location": "Save Location",
  "agents.editor.location.project": "Current Project",
  "agents.editor.location.global": "Global",
  ...
  "agents.editor.color": "Color",
  "agents.editor.hidden": "Hidden",
  "agents.editor.disabled": "Disabled",
  "agents.editor.permissions": "Permissions",
  "agents.editor.prompt": "System Prompt",
  "agents.editor.saveHint": "Saved agents take effect after reopening the project or restarting the app.",
  "agents.detail.back": "Back",
  "agents.detail.section.config": "Configuration",
  "agents.detail.section.description": "Description",
  "agents.detail.section.permissions": "Permissions",
  "agents.detail.section.prompt": "System Prompt",
  "agents.detail.duplicate": "Duplicate",
  "agents.detail.edit": "Edit",
  "agents.detail.delete": "Delete",
  "agents.toast.created": "Agent Created",
  "agents.toast.createdDesc": "Agent \"{{name}}\" saved. Reopen the project or restart the app to take effect.",
  "agents.toast.updated": "Agent Updated",
  "agents.toast.updatedDesc": "Agent \"{{name}}\" updated. Reopen the project or restart the app to take effect.",
  "agents.toast.deleted": "Agent Deleted",
  "agents.toast.deletedDesc": "Agent \"{{name}}\" has been deleted.",
  "agents.toast.saveFailed": "Save Failed",
  "agents.toast.deleteFailed": "Delete Failed",
  "agents.toast.readFailed": "Failed to read agent file",

  "requirements.prompt.title": "AI 实现 Prompt",
  "requirements.prompt.copied": "Prompt 已复制到剪贴板",
  "requirements.prompt.copyFailed": "复制 Prompt 失败",
  "requirements.prompt.copy": "复制",
  "requirements.prompt.regenerate": "重新生成",
  "requirements.prompt.expand": "展开",
  "requirements.prompt.collapse": "收起",
  "requirements.prompt.generateFirst": "点击生成 AI 实现 Prompt",
  "requirements.prompt.emptyHint": "暂无 Prompt，生成后可复制、重新生成，或填入当前会话。",
  "requirements.prompt.generateAction": "生成 AI 实现 Prompt",
  "requirements.action.rawSection": "原始需求",
  "requirements.action.fillRaw": "填入当前会话",
  "requirements.action.createSessionRaw": "新建会话",
  "requirements.action.promptSection": "AI 增强 Prompt",
  "requirements.action.sessionSection": "会话操作",
  "requirements.action.generatePrompt": "生成实现 Prompt",
  "requirements.action.copyPrompt": "复制 Prompt",
  "requirements.action.fillPrompt": "填入当前会话",
  "requirements.action.createSessionPrompt": "新建会话",
  "requirements.action.noActiveSession": "没有活跃会话，请先打开一个会话。",
  "requirements.action.noProjectContext": "没有项目上下文，请先打开一个项目。",
  "requirements.action.noSessionsInProject": "当前项目没有会话，请先创建会话。",
  "requirements.action.sessionCreated": "已为 {{id}} 创建会话",
  "requirements.execution.status.not_started": "未开始",
  "requirements.execution.status.prompt_created": "Prompt 已就绪",
  "requirements.execution.status.prompt_generated": "Prompt 已生成",
  "requirements.execution.status.filled_to_chat": "已填入会话",
  "requirements.execution.status.filled_to_session": "已填入会话",
  "requirements.execution.status.raw_filled_to_session": "已填入会话",
  "requirements.execution.status.prompt_filled_to_session": "已填入会话",
  "requirements.execution.status.session_created": "会话已创建",
  "requirements.execution.status.raw_session_created": "会话已创建",
  "requirements.execution.status.prompt_session_created": "会话已创建",
  "requirements.execution.status.implementing": "实现中",
  "requirements.execution.status.waiting_review": "待检查",
  "requirements.execution.status.done": "已完成",
  "requirements.execution.status.failed": "失败",
  "requirements.execution.linkedSession": "已关联会话",
  "requirements.detail.linkedSession": "关联会话",
  "requirements.detail.openLinkedSession": "打开关联会话",
  "requirements.detail.updateStatus": "更新状态",
  "requirements.detail.markImplementing": "实现中",
  "requirements.detail.markWaitingReview": "待检查",
  "requirements.detail.markDone": "已完成",
  "requirements.detail.markFailed": "失败",
  "requirements.detail.unlinkSession": "解除关联",
  "requirements.detail.unlinked": "已解除关联",
  "requirements.action.section": "操作",
  "requirements.action.createRequirementSession": "创建需求会话",
  "requirements.action.createAnotherSession": "创建另一个会话",
  "requirements.action.creating": "创建中...",
  "requirements.action.createAnotherConfirm": "该需求已关联 {{count}} 个会话，是否继续创建新的实现会话？",
  "requirements.action.continueCreate": "继续创建",
  "requirements.action.addToExistingSession": "绑定已有会话",
  "requirements.action.sessionConflict": "目标会话已关联其他需求：{{existingReq}} {{existingTitle}}。当前需求：{{currentReq}} {{currentTitle}}。请使用新建会话，或先解除已有关联。",
  "requirements.detail.source": "来源",
  "requirements.detail.sourceRaw": "原始需求",
  "requirements.detail.sourcePrompt": "AI Prompt",
  "requirements.detail.linkedSessions": "关联会话",
  "requirements.detail.sessionHasOtherReqs": "该会话还关联了 {{count}} 个其他需求",
  "requirements.card.relatedRequirements": "关联需求",
  "requirements.card.expand": "展开",
  "requirements.card.collapse": "收起",
  "requirements.picker.title": "选择会话",
  "requirements.picker.confirmTitle": "确认",
  "requirements.picker.noSessions": "当前项目没有会话",
  "requirements.picker.linkedCount": "已关联 {{count}} 个",
  "requirements.picker.sessionHasLinks": "该会话已关联以下需求：{{reqs}}",
  "requirements.picker.confirmAdd": "是否将当前需求（{{req}}）添加到该会话？",
  "requirements.picker.addToSession": "加入该会话",
  "requirements.picker.createNew": "新建独立会话",
  "requirements.picker.createNewInstead": "改为新建会话",
  "requirements.picker.cancel": "取消",
  "requirements.detail.created": "创建时间",
  "requirements.detail.updated": "更新时间",
  "requirements.card.viewDetail": "查看详情",
  "requirements.card.markImplementing": "实现中",
  "requirements.card.markWaitingReview": "待检查",
  "requirements.detail.project": "项目",
  "requirements.card.status.implementing": "实现中",
  "requirements.card.status.waiting_review": "待检查",
  "requirements.card.status.done": "已完成",
  "requirements.card.status.failed": "失败",
