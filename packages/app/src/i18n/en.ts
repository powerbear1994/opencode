export const dict = {
  ...
  "requirements.title": "Requirements Center",
  "requirements.list.empty": "No requirements found",
  "requirements.list.error": "Failed to load requirements",
  "requirements.list.retry": "Retry",
  "requirements.list.searchPlaceholder": "Search requirements...",
  "requirements.detail.back": "Back to list",
  "requirements.detail.notFound": "Requirement not found",
  "requirements.status.todo": "Todo",
  "requirements.status.doing": "In Progress",
  "requirements.status.done": "Done",
  "requirements.priority.high": "High",
  "requirements.priority.medium": "Medium",
  "requirements.priority.low": "Low",
  "requirements.prompt.title": "Implementation Prompt",
  "requirements.prompt.copied": "Prompt copied to clipboard",
  "requirements.prompt.copyFailed": "Failed to copy prompt",
  "requirements.action.rawSection": "Raw Requirement",
  "requirements.action.fillRaw": "Fill into Session",
  "requirements.action.createSessionRaw": "Create New Session",
  "requirements.action.promptSection": "AI Enhanced Prompt",
  "requirements.action.generatePrompt": "Generate Prompt",
  "requirements.action.copyPrompt": "Copy Prompt",
  "requirements.action.fillPrompt": "Fill into Session",
  "requirements.action.createSessionPrompt": "Create New Session",
  "requirements.action.noActiveSession": "No active session. Open a session first.",
  "requirements.action.noProjectContext": "No project context. Open a project first.",
  "requirements.action.noSessionsInProject": "No sessions in the current project. Create a session first.",
  "requirements.action.sessionCreated": "Session created for {{id}}",
  "requirements.execution.status.not_started": "Not Started",
  "requirements.execution.status.prompt_created": "Prompt Ready",
  "requirements.execution.status.prompt_generated": "Prompt Generated",
  "requirements.execution.status.filled_to_chat": "Filled to Chat",
  "requirements.execution.status.raw_filled_to_session": "Filled to Session",
  "requirements.execution.status.prompt_filled_to_session": "Filled to Session",
  "requirements.execution.status.session_created": "Session Created",
  "requirements.execution.status.raw_session_created": "Session Created",
  "requirements.execution.status.prompt_session_created": "Session Created",
  "requirements.execution.status.implementing": "Implementing",
  "requirements.execution.status.done": "Done",
  "requirements.execution.linkedSession": "Linked Session",
