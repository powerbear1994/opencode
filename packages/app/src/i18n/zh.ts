...
export const dict = {
  ...
  "settings.general.row.remoteServiceUrl.title": "远端服务 URL",
  "settings.general.row.remoteServiceUrl.description": "供指定的远端功能使用，不会改变本地 OpenCode 服务。",
  ...
  // ── Agents ──────────────────────────────────────────────────────────────
  "agents.title": "智能体",
  "agents.detail.empty": "选择一个智能体查看详情",
  "agents.list.empty": "暂无智能体",
  "agents.list.error": "加载智能体失败",
  "agents.list.retry": "重试",
  "agents.editor.nameLocked": "创建后无法修改智能体名称。",
  "agents.editor.name": "名称",
  "agents.editor.location": "保存位置",
  "agents.editor.location.project": "当前项目",
  "agents.editor.location.global": "全局",
  "agents.editor.mode": "模式",
  "agents.editor.description": "描述",
  "agents.editor.model": "模型",
  "agents.editor.temperature": "温度",
  "agents.editor.color": "颜色",
  "agents.editor.hidden": "隐藏",
  "agents.editor.disabled": "禁用",
  "agents.editor.permissions": "权限",
  "agents.editor.prompt": "系统提示词",
  "agents.editor.saveHint": "保存后需重新打开项目或重启桌面端后生效。",
  "agents.detail.back": "返回",
  "agents.detail.section.config": "配置",
  "agents.detail.section.description": "描述",
  "agents.detail.section.permissions": "权限",
  "agents.detail.section.prompt": "系统提示词",
  "agents.detail.duplicate": "复制",
  "agents.detail.edit": "编辑",
  "agents.detail.delete": "删除",
  "agents.toast.created": "智能体已创建",
  "agents.toast.createdDesc": "智能体 \"{{name}}\" 已保存，重新打开项目或重启桌面端后生效。",
  "agents.toast.updated": "智能体已更新",
  "agents.toast.updatedDesc": "智能体 \"{{name}}\" 已更新，重新打开项目或重启桌面端后生效。",
  "agents.toast.deleted": "智能体已删除",
  "agents.toast.deletedDesc": "智能体 \"{{name}}\" 已删除。",
  "agents.toast.saveFailed": "保存失败",
  "agents.toast.deleteFailed": "删除失败",
  "agents.toast.readFailed": "读取智能体文件失败",
