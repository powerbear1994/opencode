...
const STATUS_STYLE: Record<RequirementItem["status"], string> = {
  todo: "bg-[var(--v2-grey-400)]/15 text-[var(--v2-text-text-muted)]",
  doing: "bg-[var(--v2-blue-400)]/15 text-[var(--v2-blue-600)]",
  waiting_review: "bg-[var(--v2-orange-400)]/15 text-[var(--v2-orange-700)]",
